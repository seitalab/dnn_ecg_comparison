...
from codes.functions.evaluate_model import ModelEvaluatorMC as Evaluator
...
class EvalExecuterMC(TrainExecuterMC):

    def __init__(self, eval_target: str, dataset: str, device: str="cpu"):
...
if __name__ == "__main__":
    ...
    executer = EvalExecuterMC(eval_target, device)
    executer.run()
